...
- **[design-patterns](../design-patterns/SKILL.md)** - Padrões de projeto (Adapter, Facade, etc)
- **[database-architecture](../database-architecture/SKILL.md)** - Arquitetura de banco de dados

### Fluxo de Integração

```
software-architecture → hexagonal-architecture → design-patterns
                           ↓
...
1. **Escolha Arquitetura**: Use software-architecture para definir tipo
2. **Aplique Hexagonal**: Use hexagonal-architecture para isolar domínio
3. **Use Padrões**: Aplique design-patterns (Adapter, Repository, etc)
4. **Persista**: Use database-architecture para camada de dados