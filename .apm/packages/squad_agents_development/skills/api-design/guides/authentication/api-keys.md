...
```
API Key:  sk_demo_EXEMPLOXXXXXXXXXXXXXXXX
...
```http
# Exemplo fictício, não usar em produção
X-API-Key: sk_demo_EXEMPLOXXXXXXXXXXXXXXXX

Authorization: ApiKey sk_demo_EXEMPLOXXXXXXXXXXXXXXXX
```
