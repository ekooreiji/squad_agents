...
- **[user-journey-mapper](../user-journey-mapper/SKILL.md)** - Mapear jornada do usuário basedo na análise de stakeholders
- **[template-library](../template-library/SKILL.md)** - Templates de Feature Spec e Épico

### Fluxo de Integração

```
requirements-analyzer → acceptance-criteria-generator → bdd-scenarios
        ↓
...
1. **Analise Impacto**: Use stakeholder-impact-analyzer para identificar afetados
2. **Mapeie Jornada**: Continue para user-journey-mapper para validar com usuários
3. **Documente**: Use template-library para criar Feature Spec