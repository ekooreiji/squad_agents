...
Esta skill complementa o workflow de Requirements:

- **[bdd-scenarios](../bdd-scenarios/SKILL.md)** - Converter Acceptance Criteria em cenários Gherkin para testes automatizados

### Fluxo de Integração

```
requirements-analyzer → acceptance-criteria-generator → bdd-scenarios → testing-strategies
```

### Workflow

1. **Gere ACs**: Use acceptance-criteria-generator para criar critérios SMART
2. **Converta**: Use bdd-scenarios para transformar em cenários BDD
3. **Teste**: Use testing-strategies para implementar testes